...
public class CPU extends Part {
    ...
    public CPU(String quality, double price, double purchasePrice, String brand, 
              String model, int generation, int cores, double clockSpeed, double cacheSize) {
    ...
    public double calculateResaleValue() {
        ...
        return baseResaleValue * qualityMultiplier 
             + baseResaleValue * (corePerformance + clockSpeedPerformance + cacheSizePerformance);
    }
