...
public class Motherboard extends Part {
    ...
    private int ramSlots; // Added number of RAM slots
      private String chipset; // Added chipset information
       private String pciSlots;


    public Motherboard(String quality, double price, double purchasePrice, String brand, String socketType, String formFactor, int ramSlots, String chipset, String pciSlots) {
